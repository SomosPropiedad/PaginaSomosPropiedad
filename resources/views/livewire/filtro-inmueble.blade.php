<div>
    ...
    <!-- section hero -->
    <section class="py-16">
        <div class="  sm:grid grid-cols-5  px-4 py-6 min-h-full  space-y-6 sm:space-y-0 sm:gap-4">


            <div
                class="h-96 col-span-4 bg-gradient-to-tr from-indigo-800 to-pink-500 rounded-md flex items-center shadow-2xl duration-300 transition-transform transform hover:-translate-y-2">
                <div class="ml-20 w-100">
                    <h2 class="text-white text-4xl ">Todos los inmuebles</h2>
                    <p class="text-indigo-100 mt-4 capitalize font-thin tracking-wider leading-7">Encontrá el inmueble
                        perfecto para vos. Buscá por ubicación, precio y más.</p>

                    <a href="{{ route('inmuebles.publicar') }}"
                ...
                <div class="bg-white   rounded-md">
                    ...
                    <div class="bg-white rounded-md list-none  text-center ">
                        <li class="py-3 border-b-2  transition   hover:-translate-y-1 hover:scale-110  duration-300"><a
                                class="cursor-pointer  list-none  hover:text-pink-500"
                                wire:click="$set('clase','&destinacion=venta')">Todos</a></li>
                        <li class="py-3 border-b-2  transition   hover:-translate-y-1 hover:scale-110  duration-300"><a
                                class="cursor-pointer  list-none  hover:text-pink-500"
                                wire:click="$set('clase','&destinacion=venta')">Venta</a></li>
                        <li class="py-3 border-b-2 transition   hover:-translate-y-1 hover:scale-110  duration-300"><a
                                class="cursor-pointer  list-none  hover:text-pink-500"
                                wire:click="$set('clase','&destinacion=arriendo')">Arrendamiento</a>
                        </li>
                        ...
                        <div class="relative py-3 border-b-2 " x-data="{ open: false }">
                            ...
                            <div class="absolute w-60 mt-4 py-5 z-40  bg-white " x-show="open"
                                x-on:click.away="open= false">

                                <li
                                    class=" py-3 border-b-2  transition   hover:-translate-y-1 hover:scale-100  duration-300">
                                    <a class="cursor-pointer list-none  hover:text-pink-500"
                                        wire:click="$set('tipoc','&clase=Apartamento')">Apartamento</a>
                                </li>
                                ...
                                <a href="">
                                    <li
                                        ...
                                        <a class="cursor-pointer  list-none  hover:text-pink-500"
                                            wire:click="$set('tipoc','&clase=Casa')">Casa</a>
                                    </li>
                                </a>
                                ...
                                <li
                                    class=" py-3 border-b-2 transition   hover:-translate-y-1 hover:scale-110  duration-300">
                                    <a class=" cursor-pointer list-none  hover:text-pink-500"
                                        wire:click="$set('tipoc','&clase=Apto-Loft')">Apto-Loft</a>
                                </li>
                                <li
                                    class=" py-3 border-b-2 transition   hover:-translate-y-1 hover:scale-110  duration-300">
                                    <a class="cursor-pointer list-none  hover:text-pink-500"
                                        wire:click="$set('tipoc','&clase=Apartaestudio')">Apartaestudio</a>
                                </li>
                                <li
                                    class=" py-3 border-b-2 transition   hover:-translate-y-1 hover:scale-110  duration-300">
                                    <a class="cursor-pointer list-none  hover:text-pink-500"
                                        wire:click="$set('tipoc','&clase=Casa-Finca')">Casa-Finca</a>
                                </li>
                                <li
                                    class=" py-3 border-b-2 transition   hover:-translate-y-1 hover:scale-110  duration-300">
                                    <a class="cursor-pointer list-none  hover:text-pink-500"
                                        wire:click="$set('tipoc','&clase=Local')">Local</a>
                                </li>
                                <li
                                    class=" py-3 border-b-2 transition   hover:-translate-y-1 hover:scale-110  duration-300">
                                    <a class="cursor-pointer list-none  hover:text-pink-500"
                                        wire:click="$set('tipoc','&clase=Finca')">Finca</a>
                                </li>
                                <li
                                    class=" py-3 border-b-2 transition   hover:-translate-y-1 hover:scale-110  duration-300">
                                    <a class="cursor-pointer list-none  hover:text-pink-500"
                                        wire:click="$set('tipoc','&clase=Parqueadero')">Parqueadero</a>
                                </li>
                                <li class=" py-3  transition   hover:-translate-y-1 hover:scale-110  duration-300">
                                    <a class="cursor-pointer list-none  hover:text-pink-500"
                                        wire:click="$set('tipoc','&clase=Terreno')">Terreno</a>
                                </li>
        ...
        <div class="md:px-11  flex">
            ...
            <div class="px-4">
                ...
                <button
                    ...
                    type="button" data-dropdown-toggle="dropdown">Ubicación <svg class="w-4 h-4 ml-2" fill="none"
                ...
                <div class="hidden bg-white text-base z-50 list-none divide-y divide-gray-100 rounded shadow my-4"
                    ...
                    <ul class="py-1" aria-labelledby="dropdown">
                        <li>
                            <a class="cursor-pointer text-base hover:bg-pink-100 text-gray-700 block px-4 py-2"
                                wire:click="$set('tipoc','&municipio=sabaneta')">Sabaneta</a>
                        </li>
                        <li>
                            <a class="cursor-pointer text-base hover:bg-pink-100 text-gray-700 block px-4 py-2"
                                wire:click="$set('tipoc','&municipio=medellin')">Medellin</a>
                        </li>
                        <li>
                            <a class="cursor-pointer text-base font-semibold hover:bg-pink-100 text-gray-700 block px-4 py-2"
                                wire:click="$set('tipoc','&municipio=envigado')">Envigado</a>
                        </li>
                        <li>
                            <a class="cursor-pointer text-base hover:bg-pink-100 text-gray-700 block px-4 py-2"
                                wire:click="$set('tipoc','&municipio=itagui')">Itagui</a>
                        </li>
                        <li>
                            <a class="cursor-pointer text-base hover:bg-pink-100 text-gray-700 block px-4 py-2"
                                wire:click="$set('tipoc','&municipio=la estrella')">La estrella</a>
                        </li>
                        <li>
                            <a class="cursor-pointer text-base hover:bg-pink-100 text-gray-700 block px-4 py-2"
                                wire:click="$set('tipoc','&municipio=caldas')">Caldas</a>
                        </li>
                        <li>
                            <a class="cursor-pointer text-base hover:bg-pink-100 text-gray-700 block px-4 py-2"
                                wire:click="$set('tipoc','&municipio=bello')">Bello</a>
                        </li>
                        <li>
                            <a class="cursor-pointer text-base hover:bg-pink-100 text-gray-700 block px-4 py-2"
                                wire:click="$set('tipoc','&municipio=copacabana')">Copacabana</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="">
                ...
                <button
                    class=" bg-gradient-to-r from-indigo-400 to-pink-400 hover:scale-105 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center"
                    type="button" data-dropdown-toggle="dropdown">Precio <svg class="w-4 h-4 ml-2" fill="none"
                        stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg></button>
                ...
                <div class="hidden bg-white text-base z-50 list-none divide-y divide-gray-100 rounded shadow my-4"
                    id="drop">
                    <ul class="py-1" aria-labelledby="drop">
            ...
            <div
                ...
                @foreach ($inmuebles as $inmueble)
                    <div class="relative mx-2 mt-4 w-full">
                        <a href="{{route('inmuebles.show',$inmueble['consecutivo'])}}" style="text-decoration: none;"
                            ...
                            <div class="shadow-lg p-4 rounded-lg bg-white ">
                                <div class="flex justify-center relative rounded-lg overflow-hidden h-52">
                                    <div
                                        ...
                                        <div class="absolute inset-0 bg-gray-400 ">
                                            @foreach ($inmueble['imagenes'] as $fotos)
                                                <img class="h-56 w-full object-cover rounded" {{-- linea 17 remplaza la cadena exactamente la palabra fotos a Fotos ya 
                                                que el api tiene un error en la direccion de la image por ese campo --}}
                                                    src="{{ Str::replace('fotos', 'Fotos', $fotos['fotourl']) }}"
                                                    alt="">
                                            @endforeach
                                    ...
                                    <div class="absolute flex justify-center bottom-0 mb-3">
                                        <div
                                            ...
                                            <p class="flex items-center font-medium text-gray-800">
                                                <svg class="w-5 h-5 fill-current mr-2"
                                    ...
                                    <span
                                        class="absolute top-0 left-0 inline-flex mt-3 ml-3 px-3 py-2 rounded-lg z-10 bg-pink-600 text-sm font-medium text-white select-none">
                                        {{ $inmueble['tipo_servicio'] }}
                                    </span>
                                </div>

                                <div class="mt-4">
                                    <h2 class="font-medium text-base md:text-lg text-gray-800 line-clamp-1"
                                        title="{{ Str::limit($inmueble['clase'], 60) }}">
                                        {{ Str::limit($inmueble['clase'], 60) }}
                                    </h2>
                                    <p class="mt-2 text-sm text-gray-800 line-clamp-1"
                                        title="{{ Str::limit($inmueble['resumen'], 70) }}">
                                        {{ Str::limit($inmueble['resumen'], 70) }}
                                    </p>
                                </div>
                                    ...
                                    <p class="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                                        ...
                                        <span class="mt-2 xl:mt-0">
                                            @if ($inmueble['precio_venta'] == 0)
                                                {{ number_format($inmueble['precio']) }}
                                            @else
                                                {{ number_format($inmueble['precio_venta']) }}
                                            @endif
                                        </span>
                                    </p>
                                </div>
                                ...
                                <div class="py-4 text-center w-full">
                                    <a href="{{ route('inmuebles.show', $inmueble['consecutivo']) }}">
                                        <button
                                            class="bg-gradient-to-r w-full from-fuchsia-300 to-pink-400 hover:scale-105  shadow-cla-blue px-4 py-2 rounded-lg">Mas
                                            infomacion</button>
                                    </a>
