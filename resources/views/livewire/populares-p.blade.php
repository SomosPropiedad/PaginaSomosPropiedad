<div>
    <div>
        <div class="glider-contain">
            <div 
                class="lista py-6 px-4 grid sm:px-6 lg:px-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-6 gap-y-8 ">
                
                @foreach ($populares as $popular)
                    <div class="slider__section relative mx-2  w-full">
                        <a href="{{route('inmuebles.show',$popular['consecutivo'])}}" style="text-decoration: none;"
                            class="relative inline-block duration-300 ease-in-out transition-transform transform hover:-translate-y-2 w-full">
                            <div class="shadow p-4 rounded-lg bg-white">
                                <div class="flex justify-center relative rounded-lg overflow-hidden h-52">
                                    <div
                                        class="transition-transform h duration-500 transform ease-in-out hover:scale-110 w-full">
                                        <div class="absolute inset-0 bg-gray-400 ">
                                            @foreach ($popular['imagenes'] as $fotos)
                                    ...
                                    <span
                                        ...
                                        {{ $popular['tipo_servicio'] }}
                                    </span>
                                </div>
    
                                <div class="mt-4">
                                    <h2 class="font-medium text-base md:text-lg text-gray-800 line-clamp-1"
                                        title="{{ Str::limit($popular['clase'], 60) }}">
                                        {{ Str::limit($popular['clase'], 60) }}
                                    </h2>
                                ...
                                <div class="grid grid-cols-2 grid-rows-2 gap-4 mt-8">
                                    ...
                                    <p class="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                                        ...
                                        <span class="mt-2 xl:mt-0">
                                            @if ($popular['precio_venta'] == 0)
                                                {{ number_format($popular['precio']) }}
                                            @else
                                                {{ number_format($popular['precio_venta']) }}
                                            @endif
                                        </span>
                                    </p>
                                </div>
