<x-app-layout>
    ...
    <script src="https://kit.fontawesome.com/31c40f9e3c.js" crossorigin="anonymous"></script>
    ...
    <div class="white py-20 text-gray-600">
        <div class="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
            <h2 class="mb-12 text-center text-2xl text-gray-900 font-bold md:text-4xl">Información del inmueble</h2>
            <div class="grid gap-8  lg:grid-cols-2">
                                ...
                                <ul class="slides">
                                    @foreach ($inmuebles as $inmueble)
                                        @foreach ($inmueble['imagenes'] as $fotos)
                                            <li data-thumb="{{ Str::replace('fotos', 'Fotos', $fotos['fotourl']) }} "
                                                style="width:361px;  height=481px ">
                                                <img src="{{ Str::replace('fotos', 'Fotos', $fotos['fotourl']) }}" />
                                            </li>
                                        @endforeach
                                    @endforeach
                                </ul>
                ...
                <div class="p-6 border border-gray-100 rounded-xl bg-gray-50   sm:space-x-8 sm:p-8">
                    ...
                    <h2 class="mb-5 text-center text-2xl text-gray-900 font-bold md:text-4xl">{{ $inmueble['clase'] }}
                        {{ $inmueble['consecutivo'] }}
                    </h2>
                    <div class="flex mb-5 font-light opacity-70">

                        {{-- Precio --}}
                        <img src="{{ '/css/Home/img/dollar-symbol.png' }}" class="flex h-5 pt-1  mx-2"alt="">
                        ...
                        {{-- tipo de inmueble --}}
                        <img src="{{ '/css/Home/img/home.png' }}" class="flex h-5 pt-1  mx-2"alt="">
                        {{ $inmueble['clase'] }}



                        {{-- metros cuadrados --}}
                        <img src="{{ '/css/Home/img/medida-cuadrada.png' }}" class="flex h-5 pt-1  mx-2"alt="">
                        {{ number_format($inmueble['area']) }}m²

                        {{-- habitaciones --}}

                        <img src="{{ '/css/Home/img/cama-matrimonial.png' }}"
                            class="flex h-5 pt-1  mx-2"alt="">
                        {{ number_format($inmueble['alcobas']) }}

                        {{-- baños --}}

                        <img src="{{ '/css/Home/img/banera.png' }}" class="flex h-5 pt-1  mx-2"alt="">
                        {{ number_format($inmueble['baños']) }}


                        {{-- tipo de servicio --}}
                        <img src="{{ '/css/Home/img/cliente.png' }}" class="flex h-5 pt-1  mx-2"alt="">
                        {{ $inmueble['tipo_servicio'] }}

                        {{-- Ubicacion --}}
                        <img src="{{ '/css/Home/img/ubicacion.png' }}" class="flex h-5 pt-1  mx-2"alt="">
                        {{ ucfirst(strtolower($inmueble['municipio'])) }}

                    </div>
                    <div class="space-y-4 mt-6 text-center sm:mt-0 sm:text-left">
                        <p class="text-gray-600 text-center"> <span
                                class="font-serif">"</span>{{ ucfirst($inmueble['resumen']) }} <span
                                class="font-serif">"</span>
                        </p>
                    </div>

                    <div class="space-y-4 mt-10  text-center  sm:text-left">
                        <a href="https://wa.me/573206716990/?text=¡Hola!%20me%20interesa%20una%20propiedad%20con%20el%20codigo%20{{$inmueble['consecutivo']}}" target="_blank">
                            <button
                                class="bg-gradient-to-r w-full from-fuchsia-300 to-pink-400 hover:scale-105  shadow-cla-blue  py-2 rounded-lg">Agendar cita</button>
                        </a>
                ...
                @if ($inmueble['tipo_servicio'] == "Arriendo")
                <div class="">
                    <h2 class="mb-4 text-center text-2xl text-gray-900 font-bold md:text-4xl">Inmuebles
                        relacionados</h2>
                    <div class=" px-4 grid sm:px-6 lg:px-8 grid-cols-1 sm:grid-cols-2   gap-x-6 gap-y-8 ">
                        @foreach ($relacionado1 as $inmueble)
                                        ...
                                        <div class="flex justify-center relative rounded-lg overflow-hidden h-52">
                                            <div
                                                ...
                                                <div class="absolute inset-0 bg-gray-400 ">
                                                    @foreach ($inmueble['imagenes'] as $fotos)
                                                        <img class="h-56 w-full object-cover rounded"
                                                            {{-- linea 17 remplaza la cadena exactamente la palabra fotos a Fotos ya 
                ...
                @else
                    <div class="">
                        <h2 class="mb-4 text-center text-2xl text-gray-900 font-bold md:text-4xl">Inmuebles
                            relacionados</h2>
                        <div class=" px-4 grid sm:px-6 lg:px-8 grid-cols-1 sm:grid-cols-2   gap-x-6 gap-y-8 ">
                            @foreach ($relacionado2 as $inmueble)
                                <div class="relative mx-2 mt-4 w-full">
                                    <a href="{{ route('inmuebles.show', $inmueble['consecutivo']) }}"
                                        style="text-decoration: none;"
                                        class="relative inline-block duration-300 ease-in-out transition-transform transform hover:-translate-y-2 w-full">
